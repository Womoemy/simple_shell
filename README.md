...
simple_shell is designed to run in the `Ubuntu 20.04 LTS` linux environment and to be compiled using the GNU compiler collection `gcc` with flags`-Wall, -Werror, -Wextra, -pedantic and -std=gnu89.`

## Installation

   - Clone this repository: `git clone "https://github.com/Womoemy/simple_shell.git"`
...
## Authors
Womo Ebiobowei | [GitHub](https://github.com/Womoemy) | [Twitter](https://twitter.com/womoemy)

David Edu | [GitHub](https://github.com/daveeedu) | [LinkedIn](https://www.linkedin.com/in/david-edu/)
